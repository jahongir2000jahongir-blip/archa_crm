...
const routes = [
  ...
  },
  {
    ...
    name: 'Warehouse',
    component: () => import(`@/pages/${handleMobileView('Warehouse')}.vue`),
    props: true,
  },
  {
    alias: '/debtors',
    path: '/debtors/view/:viewType?',
    name: 'Debtors',
    component: () => import(`@/pages/${handleMobileView('Debtors')}.vue`),
  },
  {
    alias: '/rko',
    path: '/rko/view/:viewType?',
    name: 'RKO',
    component: () => import('@/pages/RKO.vue'),
  },
  {
    alias: '/presences',
    path: '/presences/view/:viewType?',
    name: 'Presences',
    component: () => import('@/pages/Presences.vue'),
  },
  {
    alias: '/sales',
    path: '/sales/view/:viewType?',
    name: 'Sales',
