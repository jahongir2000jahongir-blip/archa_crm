...
function getParams() {
  ...
  return {
    ...
    filters: filters,
    or_filters: orFilters.value ? JSON.stringify(orFilters.value) : null,
    order_by: order_by,
...
function updateFilter(filters, newOrFilters = null) {
  viewUpdated.value = true
  orFilters.value = newOrFilters
  if (!defaultParams.value) {
    defaultParams.value = getParams()
  }
  list.value.params = defaultParams.value
  list.value.params.filters = filters
  list.value.params.or_filters = newOrFilters ? JSON.stringify(newOrFilters) : null
