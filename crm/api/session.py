...
CRM_ALLOWED_ROLES = ["System Manager", "Sales Manager", "Sales User", "Директор", "Главный бухгалтер", "Кассир", "Пользователь"]
...
def get_users():
	...
	for user in users:
		...
		if "System Manager" in user.roles or "Директор" in user.roles:
			user.role = "System Manager"
		elif "Sales Manager" in user.roles or "Главный бухгалтер" in user.roles or "Кассир" in user.roles:
			user.role = "Sales Manager"
		elif "Sales User" in user.roles or "Пользователь" in user.roles:
		...
		user.can_edit_layout = "System Manager" in user.roles or "Sales Manager" in user.roles
